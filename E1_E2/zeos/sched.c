...
/* Queue variables for scheduler */
extern struct list_head blocked;
struct list_head freequeue;
struct list_head readyqueue;

/* Global varuable to access easily to the idle task */
...
void cpu_idle(void)
{
	/** Enable interrupts to allow the timer to interrupt the CPU
	 *  And perfom the context switch
	 */
