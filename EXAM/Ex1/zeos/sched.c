...
//EXAMEN
/** 
 * @brief Implementa initializeData(PCB)
 * Inicializa la estructura de comunicación de un proceso dado.
 * @param t Puntero a la estructura del proceso (task_struct)
 */
void initializeData(struct task_struct *t)
{
  t->comm.bytes_written = 0;
  t->comm.info_page = (page_table_entry *)NULL;   // NULL (no asignada ni mapeada)
