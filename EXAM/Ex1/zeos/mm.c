...
/**
 * @brief mapPhysicalPageFrom(PCB, address) mapea la página física del proceso en la dirección pasada.
 * @param t Puntero a la estructura del proceso (task_struct)
 * @param address Dirección lógica donde mapear la página física del proceso t
 */
...
/**
 * @brief Desmapea la página lógica de comunicación (COMM_PAGE_LOG) en el espacio de direcciones del proceso actual.
 * @param t Puntero a la estructura del proceso (task_struct)
 * @param address Dirección lógica donde se había mapeado la página física del proceso t
 */
